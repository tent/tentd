  ...
  describe "DELETE /profile/:type" do
    ...
    context 'when write_profile scope authorized' do
      ...
      context 'when :type not authorized' do
        ...
        context &unauthorized_examples
      end

      context 'when :type explicitly authorized' do
        let(:authorized_info_types) { [info.type.uri] }
        context &authorized_examples
      end

      context 'when fully authorized' do
        let(:authorized_info_types) { ['all'] }
        context &authorized_examples
      end
    end

    context 'when write_profile scope not authorized', &unauthorized_examples
  end
end
