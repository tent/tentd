Sequel.migration do
  change do
    ...
    self["INSERT INTO profile_info_versions (type_base, type_view, type_version, public, content, user_id, profile_info_id, version) (SELECT type_base, type_view, type_version, public, content, user_id, id, 1 AS version FROM profile_info);"].insert
  end
end
